                                            ...
                                            const Eigen::Vector3d &comDot)
{
    ...
    for (size_t i = 0; i < static_cast<size_t>(mb.nrBodies()); ++i)
    {
        ...
        sva::ForceVecd X_i_com_d_dual_hi = X_i_com.dualMul(body_i_Vel.crossDual(body_i_Momentum)) -
...
sva::ForceVecd sComputeCentroidalMomentum(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &com)
{
...
sva::ForceVecd
CentroidalMomentumMatrix::momentum(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &com) const
{
    using namespace Eigen;
...
sva::ForceVecd
CentroidalMomentumMatrix::sMomentum(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &com) const
{
    checkMatchBodyPos(mb, mbc);
    checkMatchBodyVel(mb, mbc);
