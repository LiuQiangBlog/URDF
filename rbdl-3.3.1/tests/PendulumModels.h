...
struct DoublePerpendicularPendulumJointCoordinates
{
    DoublePerpendicularPendulumJointCoordinates()
        : model(), q(), qd(), qdd(), tau(), l1(1.), l2(1.), m1(1.), m2(1.), idB1(0), idB2(0)
    {
...
struct DoublePerpendicularPendulumAbsoluteCoordinates
{
    DoublePerpendicularPendulumAbsoluteCoordinates()
        : model(), cs(), q(), qd(), qdd(), tau(), l1(1.), l2(1.), m1(1.), m2(1.), idB1(0), idB2(0),
          X_p1(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., 0., 0.))),
          X_s1(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., 0., 0.))),
          X_p2(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., -l1, 0.))),
          X_s2(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., 0., 0.)))
    {
        ...
        cs.AddLoopConstraint(0, idB1, X_p1, X_s1, SpatialVector(0, 0, 0, 1, 0, 0), false, 0.1, "RzBase");
        ...
        cs.AddLoopConstraint(idB1, idB2, X_p2, X_s2, SpatialVector(0, 0, 0, 1, 0, 0), false, 0.1, "RyLink1");
...
{
    SinglePendulumJointCoordinates() : model(), q(), qd(), qdd(), tau(), l1(1.), m1(1.), idB1(0)
    {
        using namespace RigidBodyDynamics;
        using namespace RigidBodyDynamics::Math;
...
struct SinglePendulumAbsoluteCoordinates
{
    SinglePendulumAbsoluteCoordinates()
        : model(), cs(), q(), qd(), qdd(), tau(), l1(1.), m1(1.), idB1(0),
          X_p1(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., 0., 0.))),
          X_s1(RigidBodyDynamics::Math::Xtrans(RigidBodyDynamics::Math::Vector3d(0., 0., 0.)))
    {
        ...
        Joint jointXYRz(SpatialVector(0., 0., 0., 1., 0., 0.), SpatialVector(0., 0., 0., 0., 1., 0.),
