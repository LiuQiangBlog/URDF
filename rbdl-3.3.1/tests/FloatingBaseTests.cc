...
TEST_CASE_METHOD(FloatingBaseFixture, __FILE__ "_TestCalcPointTransformation", "")
{
    ...
    CHECK_THAT(Vector3d(0., -1., 0.), AllCloseVector(test_point, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FloatingBaseFixture, __FILE__ "_TestCalcPointVelocityCustom", "")
{
    ...
    CHECK_THAT(point_base_velocity_reference, AllCloseVector(point_base_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FloatingBaseFixture, __FILE__ "_TestCalcPointAccelerationNoQDDot", "")
{
    ...
    CHECK_THAT(humans_point_position, AllCloseVector(point_world_position, TEST_PREC, TEST_PREC));
    CHECK_THAT(humans_point_velocity, AllCloseVector(point_world_velocity, TEST_PREC, TEST_PREC));
    CHECK_THAT(humans_point_acceleration, AllCloseVector(point_world_acceleration, TEST_PREC, TEST_PREC));
}
