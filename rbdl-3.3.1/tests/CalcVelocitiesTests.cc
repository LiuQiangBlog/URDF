...
TEST_CASE_METHOD(ModelVelocitiesFixture, __FILE__ "_TestCalcPointSimple", "")
{
    ...
    CHECK_THAT(Vector3d(0., 1., 0.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
...
TEST_CASE_METHOD(ModelVelocitiesFixture, __FILE__ "_TestCalcPointRotatedBaseSimple", "")
{
    ...
    CHECK_THAT(Vector3d(-1., 0., 0.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
    //	cout << LogOutput.str() << endl;
}
...
TEST_CASE_METHOD(ModelVelocitiesFixture, __FILE__ "_TestCalcPointRotatingBodyB", "")
{
    ...
    CHECK_THAT(Vector3d(0., 0., -1.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(ModelVelocitiesFixture, __FILE__ "_TestCalcPointRotatingBaseXAxis", "")
{
    ...
    CHECK_THAT(Vector3d(0., 2., -1.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(ModelVelocitiesFixture, __FILE__ "_TestCalcPointRotatedBaseXAxis", "")
{
    ...
    CHECK_THAT(Vector3d(-2., 0., -1.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_ FixedJointCalcPointVelocity", "")
{
    ...
    CHECK_THAT(Vector3d(0., 1., 0.), AllCloseVector(point0_velocity, TEST_PREC, TEST_PREC));
    CHECK_THAT(Vector3d(0., 2., 0.), AllCloseVector(point1_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_ FixedJointCalcPointVelocityRotated", "")
{
    ...
    CHECK_THAT(Vector3d(-1., 0., 0.), AllCloseVector(point0_velocity, TEST_PREC, TEST_PREC));
    CHECK_THAT(Vector3d(-2., 0., 0.), AllCloseVector(point1_velocity, TEST_PREC, TEST_PREC));
}
