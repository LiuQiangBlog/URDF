...
TEST_CASE_METHOD(ImpulsesFixture, __FILE__ "_TestContactImpulse", "")
{
    ...
    // cout << "Point Velocity = " << point_velocity << endl;
    CHECK_THAT(Vector3d(0., 0., 0.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(ImpulsesFixture, __FILE__ "_TestContactImpulseRotatedCollisionVelocity", "")
{
    ...
    // cout << "Point Velocity = " << point_velocity << endl;
    CHECK_THAT(Vector3d(1., 2., 3.), AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(ImpulsesFixture, __FILE__ "_TestContactImpulseRangeSpaceSparse", "")
{
    ...
    Vector3d point_velocity_direct =
        CalcPointVelocity(*model, Q, qdot_post_direct, contact_body_id, contact_point, true);
    Vector3d point_velocity_rangespace =
        CalcPointVelocity(*model, Q, qdot_post_rangespace, contact_body_id, contact_point, true);

    CHECK_THAT(qdot_post_direct, AllCloseVector(qdot_post_rangespace, TEST_PREC, TEST_PREC));
    CHECK_THAT(Vector3d(1., 2., 3.), AllCloseVector(point_velocity_rangespace, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(ImpulsesFixture, __FILE__ "_TestContactImpulseNullSpace", "")
{
    ...
    Vector3d point_velocity_direct =
        CalcPointVelocity(*model, Q, qdot_post_direct, contact_body_id, contact_point, true);
    Vector3d point_velocity_nullspace =
        CalcPointVelocity(*model, Q, qdot_post_nullspace, contact_body_id, contact_point, true);

    CHECK_THAT(qdot_post_direct, AllCloseVector(qdot_post_nullspace, TEST_PREC, TEST_PREC));
    CHECK_THAT(Vector3d(1., 2., 3.), AllCloseVector(point_velocity_nullspace, TEST_PREC, TEST_PREC));
}
