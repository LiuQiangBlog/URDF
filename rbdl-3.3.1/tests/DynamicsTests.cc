...
TEST_CASE(__FILE__ "_TestForwardDynamicsLagrangian", "")
{
    ...
    CHECK_THAT(QDDot_aba, AllCloseVector(QDDot_lagrangian, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_TestForwardDynamics3DoFModel", "")
{
    ...
    CHECK_THAT(QDDot_ref, AllCloseVector(QDDot, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_TestForwardDynamics3DoFModelLagrangian", "")
{
    ...
    CHECK_THAT(QDDot_ab, AllCloseVector(QDDot_lagrangian, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_TestForwardDynamicsTwoLegModelLagrangian", "")
{
    ...
    unsigned int hip_id, upper_leg_right_id, lower_leg_right_id, foot_right_id, upper_leg_left_id, lower_leg_left_id,
        foot_left_id;
    Body hip_body, upper_leg_right_body, lower_leg_right_body, foot_right_body, upper_leg_left_body,
        lower_leg_left_body, foot_left_body;
    ...
    // QDDot =  6.31843e-07 -6.12442e-07  9.22595e-14   3.3712e-07  4.27368e-07 -7.91795e-07   3.3712e-07  4.27368e-07
    // -7.91795e-07 QDDAB = -0.00192794    -9.81419        -0.2    0.198972 -0.00130243    0.100141    0.198972
    // -0.00130243    0.100141
    ...
    CHECK_THAT(QDDotABA, AllCloseVector(QDDot, TEST_PREC, TEST_PREC));
...
TEST_CASE_METHOD(FixedAndMovableJoint, __FILE__ "_TestForwardDynamicsFixedJoint", "")
{
    ...
    CHECK_THAT(QDDot_fixed_emulate, AllCloseVector(QDDot_fixed, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FixedAndMovableJoint, __FILE__ "_TestInverseDynamicsFixedJoint", "")
{
    ...
    CHECK_THAT(Tau_2dof, AllCloseVector(Tau_fixed, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FloatingBase12DoF, __FILE__ "_TestForwardDynamicsLagrangianPrealloc", "")
{
    ...
    CHECK_THAT(QDDot, AllCloseVector(QDDot_prealloc, 0., 0.));
}
...
TEST_CASE_METHOD(FixedBase3DoF, __FILE__ "_SolveMInvTimesTau", "")
{
    ...
    CHECK_THAT(qddot_solve_llt, AllCloseVector(qddot_minv, TEST_PREC, TEST_PREC));
}
