...
TEST_CASE(__FILE__ "_ForwardDynamicsConstraintsWithExternalForcesCorrectnessTest", "")
{
    ...
    SpatialVector fextB1 = SpatialVector(7.922073295595544e+00, 9.594924263929030e+00, 6.557406991565868e+00,
                                         3.571167857418955e-01, 8.491293058687772e+00, 9.339932477575505e+00);

    SpatialVector fextB2 = SpatialVector(6.787351548577734e+00, 7.577401305783335e+00, 7.431324681249162e+00,
    ...
    */
    ...
    ForwardDynamicsConstraintsDirect(dba.model, dba.q, dba.qd, dba.tau, dba.cs, dba.qdd, true, &fext_dba);
    SpatialVector a010c =
    ...
    ForwardDynamicsConstraintsNullSpace(dba.model, dba.q, dba.qd, dba.tau, dba.cs, dba.qdd, true, &fext_dba);
    ...
    ForwardDynamicsConstraintsRangeSpaceSparse(dba.model, dba.q, dba.qd, dba.tau, dba.cs, dba.qdd, true, &fext_dba);
    a010c = CalcPointAcceleration6D(dba.model, dba.q, dba.qd, dba.qdd, dba.idB1, Vector3d(0., 0., 0.), true);
    a020c = CalcPointAcceleration6D(dba.model, dba.q, dba.qd, dba.qdd, dba.idB2, Vector3d(0., 0., 0.), true);
    a030c = CalcPointAcceleration6D(dba.model, dba.q, dba.qd, dba.qdd, dba.idB2, Vector3d(dba.l2, 0., 0.), true);
