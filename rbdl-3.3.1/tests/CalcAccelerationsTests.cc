...
TEST_CASE_METHOD(FixedBase3DoF, __FILE__ "_TestAccelerationLinearFuncOfQddot", "")
{
    ...
    CHECK_THAT(net_acc, AllCloseVector(acc_new, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FloatingBase12DoF, __FILE__ "_TestAccelerationFloatingBaseWithUpdateKinematics", "")
{
    ...
    CHECK_THAT(Vector3d(0., -9.81, 0.), AllCloseVector(accel, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FloatingBase12DoF, __FILE__ "_TestAccelerationFloatingBaseWithoutUpdateKinematics", "")
{
    ...
    CHECK_THAT(Vector3d(0., 0., 0.), AllCloseVector(accel, TEST_PREC, TEST_PREC));
    //	cout << LogOutput.str() << endl;
...
TEST_CASE_METHOD(FixedBase3DoF, __FILE__ "_TestCalcPointRotationFixedJoint", "")
{
    ...
    CHECK_THAT(point_acceleration_reference, AllCloseVector(point_acceleration, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(FixedBase3DoF, __FILE__ "_TestCalcPointRotationFixedJointRotatedTransform", "")
{
    ...
    // cout << "Point position = " << CalcBodyToBaseCoordinates (*model, Q, fixed_body_id, Vector3d (0., 0.,
    // 0.)).transpose() << endl; cout << "Point position_ref = " << CalcBodyToBaseCoordinates (*model, Q, body_c_id,
