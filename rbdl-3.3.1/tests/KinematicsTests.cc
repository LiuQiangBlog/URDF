...
TEST_CASE_METHOD(KinematicsFixture, __FILE__ "_TestPositionNeutral", "")
{
    ...
    CHECK_THAT(Vector3d(0., 0., 0.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_a_id, Vector3d(0., 0., 0.), true), TEST_PREC,
                              TEST_PREC));
    CHECK_THAT(Vector3d(1., 0., 0.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_b_id, Vector3d(0., 0., 0.), true), TEST_PREC,
                              TEST_PREC));
    CHECK_THAT(Vector3d(1., 1., 0.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_c_id, Vector3d(0., 0., 0.), true), TEST_PREC,
                              TEST_PREC));
    CHECK_THAT(Vector3d(1., 1., -1.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_d_id, Vector3d(0., 0., 0.), true), TEST_PREC,
                              TEST_PREC));
}
...
TEST_CASE_METHOD(KinematicsFixture, __FILE__ "_TestCalcBodyToBaseCoordinates", "")
{
    ...
    CHECK_THAT(
        Vector3d(1., 2., 0.),
        AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_c_id, Vector3d(0., 1., 0.)), TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(KinematicsFixture, __FILE__ "_TestCalcBodyToBaseCoordinatesRotated", "")
{
    ...
    CHECK_THAT(Vector3d(1., 1., 0.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_c_id, Vector3d(0., 0., 0.), false), TEST_PREC,
                              TEST_PREC));

    CHECK_THAT(Vector3d(0., 1., 0.),
               AllCloseVector(CalcBodyToBaseCoordinates(*model, Q, body_c_id, Vector3d(0., 1., 0.), false), TEST_PREC,
                              TEST_PREC));
...
TEST_CASE(__FILE__ "TestCalcPointJacobian", "")
{
    ...
    CHECK_THAT(point_velocity_ref, AllCloseVector(point_velocity, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(KinematicsFixture6DoF, __FILE__ "TestInverseKinematicUnreachable", "")
{
    ...
    CHECK_THAT(Vector3d(2.0, 0., 0.), AllCloseVector(effector, TEST_LAX, TEST_LAX));
}
...
TEST_CASE(__FILE__ "_FixedJointBodyCalcBodyToBaseRotated", "")
{
    ...
    CHECK_THAT(Vector3d(0., 2., 0.), AllCloseVector(base_coords, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_FixedJointBodyCalcBaseToBodyRotated", "")
{
    ...
    CHECK_THAT(Vector3d(1., 0., 0.), AllCloseVector(base_coords, TEST_PREC, TEST_PREC));
}
...
TEST_CASE(__FILE__ "_FixedJointBodyWorldOrientation", "")
{
    ...
    CHECK_THAT(reference, AllCloseMatrix(orientation, TEST_PREC, TEST_PREC));
}
...
TEST_CASE_METHOD(Human36, __FILE__ "_SpatialJacobianFixedBody", "")
{
    ...
    auto v_fixed_body = model->mFixedBodies[fixed_body_id].mParentTransform.apply(model->v[movable_parent]);
...
TEST_CASE_METHOD(Human36, __FILE__ "_CalcPointAcceleration6D", "")
{
    ...
    SpatialVector a_foot_0_ref =
        X_foot.apply(model->X_base[foot_r_id].inverse().apply(model->a[foot_r_id]) -
                     crossm(rdot, model->X_base[foot_r_id].inverse().apply(model->v[foot_r_id])));
