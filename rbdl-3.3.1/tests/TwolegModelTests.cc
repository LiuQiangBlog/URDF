...
Body hip_body, upper_leg_right_body, lower_leg_right_body, foot_right_body, upper_leg_left_body, lower_leg_left_body,
    foot_left_body;
...
Vector3d joint_location[JointLocationLast] = {Vector3d(0., 0., 0.), Vector3d(0., -0.2425 * ModelHeight, 0.),
...
Vector3d com_position[COMNameLast] = {Vector3d(0., 0.3469 * ModelHeight, 0.), Vector3d(0., 0.2425 * ModelHeight, 0.),
                                      Vector3d(0., 0.2529 * ModelHeight, 0.), Vector3d(0.0182 * ModelHeight, 0., 0.)};
...
Vector3d rgyration[RGyrationLast] = {Vector3d(0.1981, 0.1021, 0.1848), Vector3d(0.1389, 0.0629, 0.1389),
...
TEST_CASE(__FILE__ "_TestForwardDynamicsConstraintsDirectFootmodel", "")
{
    ...
    CHECK_THAT(Vector3d(0., 0., 0.), AllCloseVector(contact_accel_left, TEST_PREC, TEST_PREC));
...
TEST_CASE(__FILE__ "_TestClearContactsInertiaMatrix", "")
{
    ...
    CHECK_THAT(QDDot_lag, AllCloseVector(QDDot_aba, TEST_PREC * QDDot_lag.norm(), TEST_PREC * QDDot_lag.norm()));
