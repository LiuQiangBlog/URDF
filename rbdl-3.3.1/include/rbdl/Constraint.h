...
public:
    ...
    */
    Constraint(const char  *nameOfConstraint,
        ...
        : typeOfConstraint(typeOfConstraint), id(userDefinedIdNumber), sizeOfConstraint(sizeOfConstraint),
          baumgarteParameters(1. / 0.1, 1. / 0.1), baumgarteEnabled(false)
    {
        name = "";
        if (nameOfConstraint)
        {
    ...
    */
                                         ...
                                         Math::VectorNd       &baumgarteForces)
    {
        ...
        baumgarteForces =
            (-2 * baumgarteParameters[0] * errVel - baumgarteParameters[1] * baumgarteParameters[1] * errPos);
    }
                                           ...
                                           Math::VectorNd       &gammaSysOutput)
    {
        ...
        for (unsigned int i = 0; i < sizeOfConstraint; ++i)
        {
            gammaSysOutput[rowInSystem + i] +=
                ...
                (baumgarteParameters[1] * baumgarteParameters[1]) * errPosSys[rowInSystem + i];
        }
    }
