...
public:
    ...
    Quaternion(Scalar x, Scalar y, Scalar z, Scalar w) : Vector4d(x, y, z, w) {}
...
// division by 0.f is unhealthy
        ...
        return Quaternion(casadi::MX::if_else(casadi::MX::lt(dot(quat), 0.), Quaternion(((*this) * p0 - quat * p1) * d),
    ...
    Matrix3d toMatrix() const
    {
        ...
        Scalar z = (*this)[2];
        Scalar w = (*this)[3];
        return Matrix3d(1 - 2 * y * y - 2 * z * z, 2 * x * y + 2 * w * z, 2 * x * z - 2 * w * y,
