 ...
 * \param change_of_angular_momentum (optional output) change of angular momentum of the model at the COM in base
 * coordinates \param update_kinematics (optional input) whether the kinematics should be updated (defaults to true)
 *
...
RBDL_DLLAPI Math::Scalar
CalcKineticEnergy(Model &model, const Math::VectorNd &q, const Math::VectorNd &qdot, bool update_kinematics = true);
} // namespace Utils
