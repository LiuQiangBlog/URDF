...
public:
    ...
    Vector2_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Vector2d(other)
    {
    }
...
public:
    ...
    template <typename OtherDerived>
    Vector3_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Vector3d(other)
    {
    }
...
public:
    ...
    template <typename OtherDerived>
    Matrix3_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Matrix3d(other)
    {
    }
...
public:
    ...
    template <typename OtherDerived>
    Vector4_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Vector4d(other)
    {
    }
...
public:
    ...
    template <typename OtherDerived>
    SpatialVector_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Matrix<double, 6, 1>(other)
    {
    }
...
public:
    ...
    template <typename OtherDerived>
    Matrix4_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Matrix<double, 4, 4>(other)
    {
    }
    ...
    EIGEN_STRONG_INLINE Matrix4_t(const Scalar &m00,
                                  const Scalar &m01,
                                  const Scalar &m02,
                                  const Scalar &m03,
                                  const Scalar &m10,
...
public:
    ...
    template <typename OtherDerived>
    SpatialMatrix_t(const Eigen::MatrixBase<OtherDerived> &other) : Eigen::Matrix<double, 6, 6>(other)
    {
    }
    ...
    EIGEN_STRONG_INLINE SpatialMatrix_t(const Scalar &m00,
                                        const Scalar &m01,
                                        const Scalar &m02,
                                        const Scalar &m03,
                                        const Scalar &m04,
