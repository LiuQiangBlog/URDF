...
/**
  ...
  \image html fig_Constraint_Loop.png "A loop constraint restricts the movement of a point p located on the predecessor
  body relative to point s on a successor body in the directions T_i."
