...
/**
  ...
  \image html fig_Constraint_Contact.png "A contact constraint restricts the movement of a point p located on a body
  such that its velocity and acceleration in direction n_i is zero."
