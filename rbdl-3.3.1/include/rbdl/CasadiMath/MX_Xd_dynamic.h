...
{
public:
    MX_Xd_dynamic(unsigned int nrows = 1, unsigned int ncols = 1) : casadi::MX(nrows, ncols) {}

    virtual ~MX_Xd_dynamic() {}

    MX_Xd_dynamic(const casadi::MX &m) : casadi::MX(m) {}
    ...
    {
        return this->casadi::MX::operator()(casadi::Slice(static_cast<casadi_int>(i), static_cast<casadi_int>(i + 1)),
