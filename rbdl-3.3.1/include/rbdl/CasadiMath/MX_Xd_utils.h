...
inline MX_Xd_scalar operator+(MX_Xd_scalar me, const MX_Xd_SubMatrix &other)
{
    return me.casadi::MX::operator+=(other);
}
inline MX_Xd_scalar operator+(MX_Xd_scalar me, const double &other)
{
    return me.casadi::MX::operator+=(other);
}
template <unsigned int nrows, unsigned int ncols>
...
inline MX_Xd_dynamic operator*(const MX_Xd_SubMatrix &me, const MX_Xd_scalar &other)
{
    return MX_Xd_SubMatrix::times(me, other);
}
inline MX_Xd_dynamic operator*(const MX_Xd_SubMatrix &me, const MX_Xd_SubMatrix &other)
{
    return MX_Xd_SubMatrix::mtimes(me, other);
}

inline MX_Xd_SubMatrix operator/(const MX_Xd_SubMatrix &me, const MX_Xd_SubMatrix &scalar)
{
    MX_Xd_SubMatrix result(me);
    result.MX_Xd_SubMatrix::operator/=(scalar);
    return result;
}
inline MX_Xd_SubMatrix operator/(const MX_Xd_SubMatrix &me, const double &scalar)
{
    MX_Xd_SubMatrix result(me);
    result.MX_Xd_SubMatrix::operator/=(scalar);
    return result;
...
inline MX_Xd_dynamic operator*(const MX_Xd_scalar &m1, const MX_Xd_dynamic m2)
{
    return casadi::MX::mtimes(m1, m2);
}
inline MX_Xd_dynamic operator*(const double &m1, const MX_Xd_dynamic m2)
{
    return casadi::MX::mtimes(m1, m2);
}
inline MX_Xd_dynamic operator*(const double &m1, const MX_Xd_SubMatrix m2)
{
    return casadi::MX::mtimes(m1, m2);
}
template <unsigned int nrows, unsigned int ncols>
...
inline MX_Xd_dynamic operator-(const MX_Xd_dynamic &me)
{
    return me.casadi::MX::operator-();
}
inline MX_Xd_dynamic operator-(const MX_Xd_SubMatrix &me)
{
    return me.casadi::MX::operator-();
}
inline MX_Xd_dynamic operator-(MX_Xd_SubMatrix me, const MX_Xd_scalar &scalar)
{
...
inline MX_Xd_scalar operator+(const MX_Xd_dynamic &me, const MX_Xd_scalar &other)
{
    MX_Xd_scalar out(me);
    return out.casadi::MX::operator+=(other);
}
inline MX_Xd_scalar operator+(const MX_Xd_scalar &me, const MX_Xd_dynamic &other)
{
    MX_Xd_scalar out(me);
    return out.casadi::MX::operator+=(other);
}
inline MX_Xd_dynamic operator+(const MX_Xd_SubMatrix &me, const MX_Xd_dynamic &other)
{
    MX_Xd_dynamic out(other);
    return out.casadi::MX::operator+=(me);
}
inline MX_Xd_dynamic operator+(const MX_Xd_dynamic &me, const MX_Xd_SubMatrix &other)
{
    MX_Xd_dynamic out(me);
    return out.casadi::MX::operator+=(other);
}

inline MX_Xd_dynamic operator+(MX_Xd_SubMatrix me, const MX_Xd_SubMatrix &other)
{
    return me.casadi::SubMatrix<casadi::MX, casadi::Slice, casadi::Slice>::operator+=(other);
}

template <unsigned int nrows, unsigned int ncols>
inline MX_Xd_static<nrows, ncols> operator-(const MX_Xd_dynamic &me, const MX_Xd_static<nrows, ncols> &other)
{
    MX_Xd_static<nrows, ncols> out(me);
    return out.casadi::MX::operator-=(other);
}
...
inline MX_Xd_scalar operator*(double other, const MX_Xd_scalar &me)
{
    return casadi::MX::times(me, other);
}
inline MX_Xd_scalar operator*(const MX_Xd_scalar &other, const MX_Xd_SubMatrix &me)
{
    return casadi::MX::times(me, other);
}
...
inline MX_Xd_scalar operator-(const MX_Xd_scalar &other)
{
    return other.casadi::MX::operator-();
}
inline MX_Xd_scalar operator-(double other, const MX_Xd_scalar &me)
