...
void printMatrixToFile(const RigidBodyDynamics::Math::MatrixNd &data, string &filename)
{
    ofstream datafile;
    datafile.open(filename.c_str());
...
calcCentralDifference(RigidBodyDynamics::Math::VectorNd &x, RigidBodyDynamics::Math::VectorNd &y, bool extrap_endpoints)
{
...
RigidBodyDynamics::Math::VectorNd
calcCentralDifference(RigidBodyDynamics::Math::VectorNd &x, SmoothSegmentedFunction &mcf, double tol, int order)
{
...
RigidBodyDynamics::Math::VectorNd calcTrapzIntegral(RigidBodyDynamics::Math::VectorNd &x,
                                                    RigidBodyDynamics::Math::VectorNd &y,
                                                    bool flag_TrueIntForward_FalseIntBackward)
{
    RigidBodyDynamics::Math::VectorNd inty = RigidBodyDynamics::Math::VectorNd::Zero(y.size());
    // inty = 0;
                         ...
                         double continuityTol)
{
    ...
    RigidBodyDynamics::Math::VectorNd fcnSample = RigidBodyDynamics::Math::VectorNd::Zero(mcfSample.rows());
                                                  ...
                                                  double tol)
{
    ...
    RigidBodyDynamics::Math::VectorNd domainX = RigidBodyDynamics::Math::VectorNd::Zero(mcfSample.rows());
    ...
    RigidBodyDynamics::Math::VectorNd errRelMax = RigidBodyDynamics::Math::VectorNd::Zero(6);
    RigidBodyDynamics::Math::VectorNd errAbsMax = RigidBodyDynamics::Math::VectorNd::Zero(6);
