...
/**
  ...
  Two-point quantites         : [ Descriptor ] [From Point       ] [To Point         ] [Resolved in frame] [*optional*
  operator]
    ...
    */
    ...
    FootPlacementEstimatorInfo()
        : f(std::numeric_limits<double>::signaling_NaN()),
          ...
          phi(std::numeric_limits<double>::signaling_NaN()), r0F0(Math::Vector3dZero),
          projectionError(std::numeric_limits<double>::signaling_NaN()), n(Math::Vector3dZero), u(Math::Vector3dZero),
          k(Math::Vector3dZero), r0C0(Math::Vector3dZero), v0C0(Math::Vector3dZero), r0P0(Math::Vector3dZero),
          HC0(Math::Vector3dZero), JC0(Math::Matrix3dZero), w0C0(Math::Vector3dZero), HP0(Math::Vector3dZero),
          JP0(Math::Matrix3dZero), w0P0(Math::Vector3dZero), h(std::numeric_limits<double>::signaling_NaN()),
          nJC0n(std::numeric_limits<double>::signaling_NaN()), v0C0u(std::numeric_limits<double>::signaling_NaN()),
          v0C0k(std::numeric_limits<double>::signaling_NaN()), w0C0n(std::numeric_limits<double>::signaling_NaN()),
          w0F0nPlus(std::numeric_limits<double>::signaling_NaN()), l(std::numeric_limits<double>::signaling_NaN()),
          E(std::numeric_limits<double>::signaling_NaN()), Df_Dphi(std::numeric_limits<double>::signaling_NaN()),
          Df_Dw0C0n(std::numeric_limits<double>::signaling_NaN()), Df_Dh(std::numeric_limits<double>::signaling_NaN()),
          Df_Dv0C0u(std::numeric_limits<double>::signaling_NaN()),
          Df_Dv0C0k(std::numeric_limits<double>::signaling_NaN()),
          Df_DnJC0n(std::numeric_limits<double>::signaling_NaN()), Df_Dm(std::numeric_limits<double>::signaling_NaN()),
          Df_Dg(std::numeric_limits<double>::signaling_NaN()), Ds_Dl(std::numeric_limits<double>::signaling_NaN()),
          Ds_DnJC0n(std::numeric_limits<double>::signaling_NaN()), Ds_DE(std::numeric_limits<double>::signaling_NaN()),
