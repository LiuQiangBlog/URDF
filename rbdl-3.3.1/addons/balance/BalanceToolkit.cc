                                                     ...
                                                     bool update_kinematics)
{
    ...
    assert((fpeInfo.k.dot(groundPlaneNormal) - 1.0) <= std::numeric_limits<double>::epsilon() * 10);

    // Evaluate the position and velocity of the COM and the whole body angular
    // velocity about the COM

    CalcCenterOfMass(model, q, qdot, NULL, m, fpeInfo.r0C0, &fpeInfo.v0C0, NULL, &fpeInfo.HC0, NULL, update_kinematics);
    ...
    for (size_t i = 1; i < model.mBodies.size(); i++)
    {
        ...
        if (model.mBodies[i].mIsVirtual == false)
        {
            ...
            fpeInfo.JC0 = fpeInfo.JC0 +
                          (model.X_base[i].E.transpose() * model.mBodies[i].mInertia * model.X_base[i].E) +
    ...
    fpeInfo.r0P0 = fpeInfo.r0C0 - ((fpeInfo.r0C0 - pointOnGroundPlane).dot(fpeInfo.k)) * fpeInfo.k;
    ...
    fBest = (t0 * t0) / (cos2phi * fpeInfo.nJC0n + h2 * m) + 2 * (cosphi - 1) * cosphi * g * fpeInfo.h * m;
    ...
    if (evaluate_derivatives)
    {
        ...
        fpeInfo.Df_Dphi = (2 * cosphi * sinphi * fpeInfo.nJC0n * (t0 * t0)) / (t1 * t1) +
                          (2 *
                           (cos2phi * fpeInfo.w0C0n * fpeInfo.nJC0n +
                            cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u)) *
                          ...
                          2 * cosphi * g * fpeInfo.h * m * sinphi - 2 * (cosphi - 1) * g * fpeInfo.h * m * sinphi;

        t0 = (cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) +
              fpeInfo.nJC0n * cos2phi * fpeInfo.w0C0n);
        ...
        fpeInfo.Df_Dh = (-(2 * fpeInfo.h * m * (t0 * t0))) / (t1 * t1) +
                        (2 * cosphi * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) *
                         (cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) +
                          fpeInfo.nJC0n * cos2phi * fpeInfo.w0C0n)) /
                            (h2 * m + fpeInfo.nJC0n * cos2phi) +
                        2 * (cosphi - 1) * cosphi * g * m;

        fpeInfo.Df_Dv0C0u = (2 * cos2phi * fpeInfo.h * m *
                             (cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) +
                              fpeInfo.nJC0n * cos2phi * fpeInfo.w0C0n)) /
                            (h2 * m + fpeInfo.nJC0n * cos2phi);

        fpeInfo.Df_Dv0C0k = (2 * cosphi * fpeInfo.h * m * sinphi *
                             (cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) +
                              fpeInfo.nJC0n * cos2phi * fpeInfo.w0C0n)) /
                            (h2 * m + fpeInfo.nJC0n * cos2phi);
        ...
        fpeInfo.Df_DnJC0n = (2 * cos2phi * fpeInfo.w0C0n *
                             (cosphi * fpeInfo.h * m * (sinphi * fpeInfo.v0C0k + cosphi * fpeInfo.v0C0u) +
                              fpeInfo.nJC0n * cos2phi * fpeInfo.w0C0n)) /
                                (h2 * m + fpeInfo.nJC0n * cos2phi) -
                            (cos2phi * (t0 * t0)) / (t1 * t1);
