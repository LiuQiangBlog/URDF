    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(c2 > 0))
    {
        ...
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAnderson2007ActiveTorqueAngleCurve " << curveName << ": c2 must be greater than 0" << endl;
    ...
    RigidBodyDynamics::Math::MatrixNd p1 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x1, y1, dydx1, x2, y2, dydx2, c);

    RigidBodyDynamics::Math::MatrixNd p2 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x2, y2, dydx2, x3, y3, dydx3, c);

    RigidBodyDynamics::Math::MatrixNd p3 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x3, y3, dydx3, x4, y4, dydx4, c);
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(mX, mY, x0, x4, y0, y4, dydx0, dydx4, curveName);
}
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(c4 < c5))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAndersonActiveTorqueVelocityCurve " << curveName << ": c4 must be greater than c5" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!((c4 > 0)))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAndersonActiveTorqueVelocityCurve " << curveName << ": c4 must be greater than 0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(c6 > 0.0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAndersonActiveTorqueVelocityCurve " << curveName << ": c6 must be greater than 1.0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(scale > 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAnderson2007PassiveTorqueAngleCurve " << curveName << ": scale must be greater than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(c1 > 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAnderson2007PassiveTorqueAngleCurve " << curveName << ": c1 must be greater than 0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    case 0:
    {
        ...
        RigidBodyDynamics::Math::MatrixNd p0 =
            SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(0., 0., 0., 1., 0., 0., c);
    ...
    case 1:
    {
        ...
        RigidBodyDynamics::Math::MatrixNd p1 =
            SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x2, y2, dydx2, x1, y1, dydx1, c);
        RigidBodyDynamics::Math::MatrixNd p2 =
            SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x1, y1, dydx1, x0, y0, dydx0, c);
    ...
    default:
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createAnderson2007PassiveTorqueAngleCurve " << curveName << ": undefined curveType" << endl;
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(mX, mY, xStart, xEnd, yStart / c1Scale, yEnd / c1Scale,
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if ((tvAtEccentricOmegaMax < 1.05))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTorqueVelocityCurve " << curveName << ": tvAtEccentricOmegaMax must be greater than 1.05"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }

    if ((tvAtHalfConcentricOmegaMax < 0.05 || tvAtHalfConcentricOmegaMax > 0.45))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
    ...
    if ((slopeAtConcentricOmegaMax > 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTorqueVelocityCurve " << curveName << ": slopeAtConcentricOmegaMax cannot be less than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((slopeNearEccentricOmegaMax > 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTorqueVelocityCurve " << curveName << ": slopeNearEccentricOmegaMax cannot be less than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((slopeAtEccentricOmegaMax > 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTorqueVelocityCurve " << curveName << ": slopeAtEccentricOmegaMax cannot be less than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((eccentricCurviness < 0 || eccentricCurviness > 1.0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTorqueVelocityCurve " << curveName << ": eccentricCurviness must be in the interval [0,1]"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    */
    ...
    MatrixNd pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xIso, yIso, dydxIso, xNearC,
                                                                                       yNearC, dydxNearC, cC);
    MatrixNd xpts(6, 1);
    ...
    for (int i = 0; i < 10; ++i)
    {
        ...
        pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xIso, yIso, dydxIso, xNearC, yNearC,
                                                                                  dydxNearC, cCLeft);
        xpts.col(0) = pts.col(0);
        ypts.col(0) = pts.col(1);
        fvCFcnLeft.updSmoothSegmentedFunction(xpts, ypts, xIso, xNearC, yIso, yNearC, dydxIso, dydxNearC, fvLeftName);
        fLeft = 0;
        for (int j = 0; j < nSample; ++j)
        {
            w = ((double)(j - 1)) * wmaxC / ((double)nSample - 1.0);
        ...
        xpts.col(0) = pts.col(0);
        ypts.col(0) = pts.col(1);
        fvCFcnRight.updSmoothSegmentedFunction(xpts, ypts, xIso, xNearC, yIso, yNearC, dydxIso, dydxNearC, fvRightName);
        fRight = 0;
        for (int j = 0; j < nSample; ++j)
        {
            w = ((double)(j - 1)) * wmaxC / ((double)nSample - 1.0);
    ...
    pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xNearE, yNearE, dydxNearE, xIso, yIso,
                                                                              dydxIso, cE);
    ...
    pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xNearC, yNearC, dydxNearC, xC, yC,
                                                                              slopeAtConcentricOmegaMax, cC);

    xM.col(3) = pts.col(0);
    yM.col(3) = pts.col(1);

    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(xM, yM, xE, xC, yE, yC, slopeAtEccentricOmegaMax,
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (abs(stiffnessAtLowTorque) > (0.9 / abs(angleAtOneNormTorque - angleAtZeroTorque)))
    {
        ...
        errormsg << "TorqueMuscleFunctionFactory::"
                 ...
                 << "large, it exceeds 0.9/abs(angleAtOneNormTorque-angleAtZeroTorque)" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (abs(stiffnessAtOneNormTorque) < (1.1 / abs(angleAtOneNormTorque - angleAtZeroTorque)))
    {
        ...
        errormsg << "TorqueMuscleFunctionFactory::"
                 ...
                 << "small, it is less than 1.1/abs(angleAtOneNormTorque-angleAtZeroTorque)" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((curviness < 0 || curviness > 1.0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createPassiveTorqueAngleCurve " << curveName << ": curviness must be in the interval [0,1]"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (abs(stiffnessAtOneNormTorque) > SQRTEPS)
    {
        ...
        double delta = min(0.1 * (1.0 - abs(1.0 / stiffnessAtOneNormTorque)), 0.05 * abs(x1 - x0));
        ...
        pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xLow, yLow, stiffnessAtLowTorque, x1,
                                                                                  y1, dydx1, c);
        xM.col(1) = pts.col(0);
        yM.col(1) = pts.col(1);
    }
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(xM, yM, x0, x1, y0, y1, dydx0, dydx1, curveName);
}
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    createGaussianShapedActiveTorqueAngleCurve(angleAtOneNormTorque, angularStandardDeviation, 0.0, 0.0, 0.5, curveName,
                                               smoothSegmentedFunctionToUpdate);
}
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if ((minValueAtShoulders < 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createGaussianShapedActiveTorqueAngleCurve " << curveName << ": minValueAtShoulders is less than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((minSlopeAtShoulders < 0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createGaussianShapedActiveTorqueAngleCurve " << curveName << ": minSlopeAtShoulders is less than 0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((angleAtOneNormTorque - thetaMin) < (angleAtOneNormTorque - angularStandardDeviation))
    {
    ...
    double y0 = minValueAtShoulders;
    double y1 = exp(-(x1 - angleAtOneNormTorque) * (x1 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq));
    double y2 = exp(-(x2 - angleAtOneNormTorque) * (x2 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq));
    double y3 = exp(-(x3 - angleAtOneNormTorque) * (x3 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq));
    double y4 = minValueAtShoulders;

    double dydx1 = -(2 * (x1 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq)) * y1;
    double dydx2 = -(2 * (x2 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq)) * y2;
    double dydx3 = -(2 * (x3 - angleAtOneNormTorque) / (2 * angularStandardDeviationSq)) * y3;
    ...
    pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x2, y2, dydx2, x3, y3, dydx3, c);

    xM.col(2) = pts.col(0);
    yM.col(2) = pts.col(1);

    pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x3, y3, dydx3, x4, y4, dydx4, c);

    xM.col(3) = pts.col(0);
    yM.col(3) = pts.col(1);

    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(xM, yM, x0, x4, y0, y4, dydx0, dydx4, curveName);
}
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    createTendonTorqueAngleCurve(angularStretchAtOneNormTorque, 1.5 / angularStretchAtOneNormTorque, 1.0 / 3.0, 0.5,
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (angularStretchAtOneNormTorque < SQRTEPS)
    {
        ...
        errormsg << "TorqueMuscleFunctionFactory::"
                 ...
                 << ": angularStretchAtOneNormTorque should be greater than sqrt(eps)" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (stiffnessAtOneNormTorque < 1.1 / angularStretchAtOneNormTorque)
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTendonTorqueAngleCurve " << curveName << ": stiffnessAtOneNormTorque should be greater "
    ...
    if (normTorqueAtToeEnd < SQRTEPS || normTorqueAtToeEnd > 0.99)
    {
        ...
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTendonTorqueAngleCurve " << curveName
                 << ": normTorqueAtToeEnd must be in the inteval [sqrt(eps), 0.99]" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if ((curviness < 0 || curviness > 1.0))
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createTendonTorqueAngleCurve " << curveName << ": curviness must be in the interval [0,1]" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    pts = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xToeCtrl, yToeCtrl, dydxToeMid, xToe,
                                                                              yToe, dydxIso, c);
    xM.col(1) = pts.col(0);
    yM.col(1) = pts.col(1);

    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(xM, yM, x0, xToe, y0, yToe, dydx0, dydxIso, curveName);
}
    ...
    RigidBodyDynamics::Addons::Geometry::SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    if (abs(normAngularVelocityAtMaximumDamping) < SQRTEPS)
    {
        ostringstream errormsg;
        errormsg << "TorqueMuscleFunctionFactory::"
                 << "createDampingBlendingCurve " << curveName << ": |normAngularVelocityAtMaximumDamping| < SQRTEPS"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(xM, yM, x0, x2, y0, y2, dydx0, dydx2, curveName);
}
