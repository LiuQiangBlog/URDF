                                                              ...
                                                              SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(dydx >= 0 && dydx < dydxUpperBound))
    {
        ...
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberActiveForceLengthCurve:" << curveName
                 << ": plateauSlope must be greater than 0 and less than " << dydxUpperBound << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(curviness >= 0 && curviness <= 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberActiveForceLengthCurve:" << curveName << ": curviness must be between 0 and 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    RigidBodyDynamics::Math::MatrixNd p0 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x0, ylow, dydx0, x01, y01, dydx01, c);
    RigidBodyDynamics::Math::MatrixNd p1 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x01, y01, dydx01, x1s, y1s, dydx1s, c);
    RigidBodyDynamics::Math::MatrixNd p2 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x1s, y1s, dydx1s, x2, y2, dydx2, c);
    RigidBodyDynamics::Math::MatrixNd p3 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x2, y2, dydx2, x23, y23, dydx23, c);
    RigidBodyDynamics::Math::MatrixNd p4 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(x23, y23, dydx23, x3, ylow, dydx3, c);
                                                          ...
                                                          SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(fmaxE > 1.0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve: " << curveName << ": fmaxE must be greater than 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(dydxC >= 0.0 && dydxC < 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve: " << curveName << ": dydxC must be greater than or equal to 0 "
    ...
    if (!(dydxNearC > dydxC && dydxNearC <= 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve: " << curveName << ": dydxNearC must be greater than or equal to 0 "
                 << "and less than 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(dydxIso > 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve: " << curveName << ": dydxIso must be greater than (fmaxE-1)/1 ("
                 << ((fmaxE - 1.0) / 1.0) << ")" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(dydxE >= 0.0 && dydxE < (fmaxE - 1)))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve: " << curveName << ": dydxE must be greater than or equal to 0 "
    ...
    if (!(concCurviness <= 1.0 && concCurviness >= 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve " << curveName << ": concCurviness must be between 0 and 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(eccCurviness <= 1.0 && eccCurviness >= 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityCurve " << curveName << ": eccCurviness must be between 0 and 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    RigidBodyDynamics::Math::MatrixNd concPts1 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
        xC, yC, dydxC, xNearC, yNearC, dydxNearC, cC);
    RigidBodyDynamics::Math::MatrixNd concPts2 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
        xNearC, yNearC, dydxNearC, xIso, yIso, dydxIso, cC);
    RigidBodyDynamics::Math::MatrixNd eccPts1 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
        xIso, yIso, dydxIso, xNearE, yNearE, dydxNearE, cE);
    RigidBodyDynamics::Math::MatrixNd eccPts2 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(mX, mY, xC, xE, yC, yE, dydxC, dydxE, curveName);
}
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(fmaxE > 1.0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityInverseCurve: " << curveName << ": fmaxE must be greater than 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }

    double SimTKSignificantReal = pow((double)std::numeric_limits<double>::epsilon(), 7.0 / 8.0);

    if (!(dydxC > SimTKSignificantReal && dydxC < 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityInverseCurve " << curveName << ": dydxC must be greater than 0"
                 << "and less than 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(dydxNearC > dydxC && dydxNearC < 1))
    {
        ...
        errormsg << "MuscleFunctionFactory::"
                 ...
                 << ": dydxNearC must be greater than 0 " << curveName << " and less than 1" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(dydxE > SimTKSignificantReal && dydxE < (fmaxE - 1)))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityInverseCurve " << curveName << ": dydxE must be greater than or equal to 0"
                 << " and less than fmaxE-1 (" << (fmaxE - 1) << ")" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(concCurviness <= 1.0 && concCurviness >= 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityInverseCurve " << curveName << ": concCurviness must be between 0 and 1"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(eccCurviness <= 1.0 && eccCurviness >= 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceVelocityInverseCurve " << curveName << ": eccCurviness must be between 0 and 1"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(mY, mX, yC, yE, xC, xE, 1 / dydxC, 1 / dydxE, curveName);
}
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(k > (1.0 / (M_PI / 2.0 - phi0))))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberCompressiveForcePennationCurve " << curveName << ": k must be greater than "
                 << (1.0 / (M_PI / 2.0 - phi0)) << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(k < 1 / cosPhi0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberCompressiveForceCosPennationCurve " << curveName << ": k must be less than 0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(lmax > 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberCompressiveForceLength " << curveName << ": l0 must be greater than 0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(k < -(1.0 / lmax)))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberCompressiveForceLength " << curveName << ": k must be less than " << -(1.0 / lmax)
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(curviness >= 0 && curviness <= 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberCompressiveForceLength " << curveName << ": curviness must be between 0.0 and 1.0"
                 << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
                                                        ...
                                                        SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(eIso > eZero))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceLength " << curveName << ": The following must hold: eIso  > eZero" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(kIso > (1.0 / (eIso - eZero))))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceLength " << curveName << ": kiso must be greater than 1/(eIso-eZero) ("
                 << (1.0 / (eIso - eZero)) << ")" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(kLow > 0.0 && kLow < 1 / (eIso - eZero)))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceLength " << curveName << ": kLow must be greater than 0 and less than"
                 << 1.0 / (eIso - eZero) << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(curviness >= 0 && curviness <= 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createFiberForceLength " << curveName << ": curviness must be between 0.0 and 1.0" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    RigidBodyDynamics::Math::MatrixNd p0 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xZero, yZero, 0, xLow, yLow, kLow, c);

    RigidBodyDynamics::Math::MatrixNd p1 =
        SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(xLow, yLow, kLow, xIso, yIso, kIso, c);
                                                         ...
                                                         SmoothSegmentedFunction &smoothSegmentedFunctionToUpdate)
{
    ...
    if (!(eIso > 0))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createTendonForceLengthCurve " << curveName << ": eIso must be greater than 0, but " << eIso
                 << " was entered" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(fToe > 0 && fToe < 1))
    {
        ...
        errormsg << "MuscleFunctionFactory::"
                 ...
                 << ": fToe must be greater than 0 and less than 1, but " << fToe << " was entered" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(kIso > (1 / eIso)))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createTendonForceLengthCurve " << curveName << ": kIso must be greater than 1/eIso, ("
                 << (1 / eIso) << "), but kIso (" << kIso << ") was entered" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    if (!(curviness >= 0 && curviness <= 1))
    {
        ostringstream errormsg;
        errormsg << "MuscleFunctionFactory::"
                 << "createTendonForceLengthCurve " << curveName << " : curviness must be between 0.0 and 1.0, but "
                 << curviness << " was entered" << endl;
        throw RigidBodyDynamics::Errors::RBDLInvalidParameterError(errormsg.str());
    }
    ...
    // Compute the Quintic Bezier control points
    RigidBodyDynamics::Math::MatrixNd p0 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
        x0, y0, dydx0, xToeCtrl, yToeCtrl, dydxToeMid, c);
    RigidBodyDynamics::Math::MatrixNd p1 = SegmentedQuinticBezierToolkit::calcQuinticBezierCornerControlPoints(
    ...
    smoothSegmentedFunctionToUpdate.updSmoothSegmentedFunction(mX, mY, x0, xToe, y0, yToe, dydx0, dydxIso, curveName);
}
