 ...
 */
RBDL_ADDON_DLLAPI
bool LuaModelReadFromFile(const char *filename, Model *upd_model, bool verbose = false);
...
*/
RBDL_ADDON_DLLAPI
bool LuaModelReadHumanMetaData(const char *filename, HumanMetaData &human_meta_data, bool verbose = false);
...
*/
RBDL_ADDON_DLLAPI
bool LuaModelWriteModelHeaderEntries(const char *header_file_name, const RigidBodyDynamics::Model &model, bool append);
/**
