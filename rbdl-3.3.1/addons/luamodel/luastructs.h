...
{
    Point()
        : name("unknown"), body_id(std::numeric_limits<unsigned int>::signaling_NaN()), body_name(""),
          point_local(std::numeric_limits<double>::signaling_NaN(),
...
{
    HumanMetaData()
        : gender("nan"), age(std::numeric_limits<double>::signaling_NaN()), age_group("nan"),
          height(std::numeric_limits<double>::signaling_NaN()), mass(std::numeric_limits<double>::signaling_NaN())
    {
    }
    std::string gender;
...
struct Millard2016TorqueMuscleConfig
{
    Millard2016TorqueMuscleConfig()
        : name(""), angle_sign(std::numeric_limits<double>::signaling_NaN()),
          torque_sign(std::numeric_limits<double>::signaling_NaN()), body(""), joint_index(0), q_scale(1.0),
          activation_index(std::numeric_limits<unsigned int>::signaling_NaN()), q_index(0), qdot_index(0),
          force_index(0), data_set("Gymnast"), age_group(""), gender(""), joint_angle_offset(0.0),
          ...
          fit_passive_torque_scale(RigidBodyDynamics::Math::Vector3d(std::numeric_limits<double>::signaling_NaN(),
                                                                     std::numeric_limits<double>::signaling_NaN(),
                                                                     std::numeric_limits<double>::signaling_NaN())),
          fit_passive_torque_offset(RigidBodyDynamics::Math::Vector3d(std::numeric_limits<double>::signaling_NaN(),
                                                                      std::numeric_limits<double>::signaling_NaN(),
                                                                      std::numeric_limits<double>::signaling_NaN()))
    {
    }
