...
{
    /**
     * @brief Controller using position commands
     * @details
     *
     * @tparam dof number of degrees of freedom of the controlled system
     */
    template <int dof>
    class PositionController : public Controller<dof>,
                               public sackmesser::FactoryClass<PositionController<dof>, const sackmesser::Interface::Ptr &, const std::string &>
    {
      public:
        /**
    ...
    using PositionReferenceController = ReferenceController<Reference, PositionController<dof>>;
