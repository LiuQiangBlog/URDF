 ...
 * @param prec Absolute precision used by numerical integrators.
 */
void integration(const MultiBody &mb, MultiBodyConfig &mbc, double step, double prec = 1e-10);

/// safe version of @see integration.
void sIntegration(const MultiBody &mb, MultiBodyConfig &mbc, double step, double prec = 1e-10);
