...
public:
    ...
    vectorJacobian(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &vector);
     ...
     */
    const Eigen::MatrixXd &
    vectorBodyJacobian(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &vector);
     ...
     */
    const Eigen::MatrixXd &
    sVectorBodyJacobian(const MultiBody &mb, const MultiBodyConfig &mbc, const Eigen::Vector3d &vec);
